...
from .boundary import (ANIMATION_STEP_ENTRY, CAMERA_FOLLOW_ENTRY, COLLISION_GATE_ENTRY, COUNTDOWN_CHECK_ENTRY,
                       FOOTPRINT_STAMP_ENTRY, GRID_CELL_ENTRY, PARTICLE_EMIT_ENTRY, SOLID_DRAW_ENTRY,
                       SPAWN_QUEUE_ENTRY, SPRITE_EMIT_ENTRY, STATIC_EMIT_ENTRY, TABLE_RESET_ENTRY,
                       ZONE_CHECK_ENTRY, animation_step_plan, camera_follow_plan, collision_gate_plan,
                       countdown_check_plan, draw_solid_plan, footprint_stamp_plan, grid_cell_plan,
                       particle_emit_plan, spawn_queue_plan, sprite_emit_plan, static_emit_plan,
                       table_reset_plan, zone_check_plan)
...
PLANNERS = {
    ...
    'camera-sprites': {CAMERA_FOLLOW_ENTRY: camera_follow_plan, SPRITE_EMIT_ENTRY: sprite_emit_plan,
                       ...
                       PARTICLE_EMIT_ENTRY: particle_emit_plan},
}
