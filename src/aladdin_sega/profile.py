...
CORE_COMMIT = "6c971b08c0698cd5fe56ab0ed855df4cbfc0b511"
...
PROFILE = {
    ...
    "power_on": "portforge-zero-ram", "core_commit": CORE_COMMIT,
    "scheduler": "portforge-rule6-instruction-boundaries",
    "audio": "nuked-opn2-ym2612+nuked-psg;pcm-s16-clamped",
    "snapshot": "alnat001+pf-genesis-snapshot-v2",
}
