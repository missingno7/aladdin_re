...
from .game.objects.contact import decrement_decimal_counter, contact_type03_retype
from .game.objects.contact import contact_type2c_stash
...
from .game.objects.lifecycle import (
    ...
    offset_second_reverse_spawn,
    jitter_reverse_spawn_x,
    finish_reverse_spawn_script,
    finish_reverse_spawn_flag,
    spawn_upper_fifth_coordinates,
    finish_upper_fifth_spawn,
    free_object,
    free_object_reverse,
    initialize,
    relocate_object,
