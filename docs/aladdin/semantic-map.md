...
docs/aladdin/native-frontier.md for the audit and the input rule.
...
results and the audit are in docs/aladdin/native-frontier.md.  (The
...
last life at frame 79293; see docs/aladdin/native-frontier.md): the high-score screen 1B0CBC (recovered from the
