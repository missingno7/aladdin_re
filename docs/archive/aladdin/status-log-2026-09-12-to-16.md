# Aladdin status log, 12 to 16 September 2026
...
This is the chronological log of the Aladdin recovery project as it was
written, newest section first (the former `docs/STATUS.md`).  The current
Aladdin status is [../../aladdin/STATUS.md](../../aladdin/STATUS.md).
...
constructed-smoke operations.  Details and examples are in [history.md](../../common/history-and-replay.md).
...
See [archive/STATUS-pre-history-2026-09-13.md](STATUS-pre-history-2026-09-13.md)
