...
Current policy, 13 September 2026. This replaces the initial ownership proposal.
The goal is editable Aladdin source in Python, with progressively less original
M68000 execution. Windows x64 is the supported development and verification host.
...
Current archives are version 2 and declare machine-state contract 1. Validate
