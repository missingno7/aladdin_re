...
oracle_spec = importlib.util.spec_from_file_location(
    'oracle_witness', Path(__file__).resolve().parents[3] / 'scripts' / 'aladdin' / 'oracle_witness.py')
...
spec = importlib.util.spec_from_file_location('spawn_allocator_facts',
    Path(__file__).resolve().parents[3] / 'scripts' / 'aladdin' / 'spawn_allocator_facts.py')
