...
1B6C0E, 1B72FC, 1B6FAE and 1B6756 are spawn dispatcher callbacks
(``--parent 1AE46C`` census) whose recorded evidence shows a RAM-only
recipe-matched arm alongside an arm no recipe reaches: 1B6C0E's and
1B6FAE's successful-allocation/FFF175-clear arm (when 1B6FAE's own
...
residue, which lands 1B6C0E, 1B6FAE and 1B6756 on their declining arm and
would break the suite's blanket ``fallbacks == 0`` assumption.  This
module qualifies all four directly instead, mirroring
