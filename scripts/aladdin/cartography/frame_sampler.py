...
sys.path.insert(0, str(__import__('pathlib').Path(__file__).resolve().parents[3] / 'src')); sys.path.insert(0, 'D:/Prog/aladdin_re/scripts'); sys.path.insert(0, 'D:/Prog/aladdin_re/scripts/aladdin')
