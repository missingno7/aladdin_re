...
oracle is the replay clock of the native run (scripts/aladdin/native_replay
...
def known_checkpoints():
    ...
    source = (Path(__file__).resolve().parents[2] / 'src' / 'aladdin_sega' / 'native' / 'sequences.py').read_text(encoding='utf-8')
