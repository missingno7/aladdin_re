"""leaf_review: the supervision gate for one recovered leaf.
    ...
    python scripts/aladdin/leaf_review.py [--artifacts DIR] [--suite MODULE ...] [--no-tests]
...
FOCUSED = ['tests/games/aladdin/test_contact_family.py', 'tests/games/aladdin/test_contact_type55.py', 'tests/games/aladdin/test_contact_type20.py',
           'tests/games/aladdin/test_contact_scan.py', 'tests/games/aladdin/test_contact_step.py', 'tests/games/aladdin/test_contact_step_sound.py',
           'tests/games/aladdin/test_collection_dispatch.py', 'tests/games/aladdin/test_recovery.py', 'tests/games/aladdin/test_pathfacts.py']
PINNED_GATES = 62
...
def _environment():
    env = dict(os.environ)
    env['PYTHONPATH'] = os.pathsep.join(str(ROOT / part) for part in ('src', 'scripts', 'scripts/aladdin', 'tests'))
